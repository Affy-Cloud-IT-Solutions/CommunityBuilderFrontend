...
export const Home = () => {
  ...
  return (
    <div className="main_over">
      <div className="container-fluid">
        <Navbar />
        <div className="row kha">
          <div className="col-lg-6 col-md-6 left1 col-sm-12 px-5">
            <h2 ref={heading10}>A better community platform for the</h2>
          ...
          <div className="col-lg-6 col-md-6 col-sm-12">
            <div className="p-4 imghome">
              <img ref={img} src="https://nodebb.org/wp-content/uploads/2021/09/Group-3681-1536x1346.png" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container py-5">
          <div className="row g-5">
            <div className="col-lg-6">
              ...
              <button class="btn mt-3 py-md-3 px-md-5 me-3 rounded-pill quote_btn1 animated ">Learn More</button>
            </div>
