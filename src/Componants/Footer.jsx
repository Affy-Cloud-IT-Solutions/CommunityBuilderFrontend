                    ...
                    <div class="container text-center text-md-start">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-3 ">
                                ...
                                <p>
                                    <Link to="/customer"> <a class="text-reset talk1 talk">Education & Finance</a></Link>
                                </p>
                                <p>
                                    <Link to="/cloud"> <a class="text-reset talk1  talk">Tech & Startups</a></Link>
                                </p>
                                <p>
                                    <Link to="/cloud"> <a class="text-reset talk1  talk">Gaming Communities</a></Link>
                                </p>
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-3 mb-4">
                                ...
                                <a href='https://affyclouditsolutions.com/' target="_blank"><p className='talk'>Product</p></a>
